...
class ChatMessage extends StatelessWidget {
  const ChatMessage({Key? key, required this.text, required this.animationController})
      : super(key: key);
        ...
        child: Row(
          ...
          children: [
            Container(
              ...
              child: CircleAvatar(backgroundColor: Colors.purple, child: Text(_name[0])),
            ),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
